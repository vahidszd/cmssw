...
for pu in 200
do 
    for scanName in WithTimewalkComp NoTimewalkComp Vtsh30mV Vtsh60mV Vtsh90mV
    do
        ./ExtractPlots_v8.py -i ./output/results/outPlotterMerged_$scanName\_pu$pu\.root -p $pu
    done    
done
