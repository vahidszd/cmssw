...
oututFilePathName='file:'+outputFileName
...
process.FbcmNtuple = cms.EDAnalyzer('FbcmNtuplizer_v4',
                                    ...
                                    TreeName = cms.string( 'PU{0}'.format(0)),
                                    InstanceNameTags = cms.vstring(
                                                    'SiPad') # provide a list of valid instanse
                                    )
 
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string(oututFilePathName),
...
process.schedule = cms.Schedule(process.digitisation_step,process.endjob_step,process.nTuple_step)
