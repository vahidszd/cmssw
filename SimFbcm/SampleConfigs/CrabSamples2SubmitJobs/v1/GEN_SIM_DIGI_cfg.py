...
minBiasFiles = ['/store/group/dpg_bril/comm_bril/phase2-sim/FBCMV2/MinBias/FBCMV2MinBias/210818_132700/0000/MinBias_14TeV_pythia8_TuneCUETP8M1_GEN_SIM_{0}.root'.format(d) for d in range(1,1000) if d not in [740,184 , 26,639] ]
minBiasFiles.append( '/store/group/dpg_bril/comm_bril/phase2-sim/FBCMV2/MinBias/FBCMV2MinBias/210818_132700/0001/MinBias_14TeV_pythia8_TuneCUETP8M1_GEN_SIM_1000.root' )
# import ROOT
# for f in minBiasFiles:
#         try:
#                 ff = ROOT.TFile.Open( '/eos/cms/{0}'.format(f) )
#                 ff.Close()
...
from SLHCUpgradeSimulations.Configuration.aging import customise_aging_1000, customise_aging_3000, customise_aging_4500_ultimate
