...
config.General.requestName = 'FBCMV2MinBiasGeneration'
...
config.Data.totalUnits = 2000000 #config.Data.unitsPerJob * NJOBS
config.Data.publication = True
config.Data.outputDatasetTag = 'FBCMV2MinBias'
