...
# with command line options: --evt_type SingleNuE10_cfi -s GEN,SIM --mc --fileout file:GEN_SIM.root --conditions auto:phase1_2021_realistic --era Run3,fbcmDigi,OnlyfbcmDigi --geometry Extended2021Bcm1fMSMR --pileup_input file:MinBias_14TeV_pythia8_TuneCUETP8M1_GEN_SIM.root --pileup "AVE_200_BX_25ns,{'B':(-3,3),'N':1.5}" --datatier GEN-SIM-DIGI-RAW --eventcontent FEVTDEBUG --python_filename GEN_SIM_cfg.py --customise Configuration/DataProcessing/Utils.addMonitoring --nThreads 2 -n 2 --no_exe
...
process = cms.Process('SIM',Run3,fbcmDigi,OnlyfbcmDigi)
