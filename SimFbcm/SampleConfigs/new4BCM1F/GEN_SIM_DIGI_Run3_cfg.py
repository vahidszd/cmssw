...
# with command line options: --evt_type SingleNuE10_cfi -s GEN,SIM,DIGI --mc --fileout file:GEN_SIM_DIGI_Run3.root --conditions auto:phase1_2021_realistic --era Run3,fbcmDigi,OnlyfbcmDigi --geometry Extended2021Bcm1fRun3 --pileup_input file:MinBias_14TeV_pythia8_TuneCUETP8M1_GEN_SIMRun3.root --pileup "AVE_200_BX_25ns,{'B':(-3,3),'N':1.5}" --datatier GEN-SIM-DIGI-RAW --eventcontent FEVTDEBUG --python_filename GEN_SIM_DIGI_Run3_cfg.py --customise SimFbcm/SiPadDigitizer/aging.no_aging,Configuration/DataProcessing/Utils.addMonitoring --nThreads 2 -n 2 --no_exe
...
process.load('Configuration.Geometry.GeometryExtended2021Bcm1fRun3Reco_cff')
process.load('Configuration.Geometry.GeometryExtended2021Bcm1fRun3_cff')
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN_SIM_DIGI_Run3.root'),
...
process.mix.input.fileNames = cms.untracked.vstring(['file:MinBias_14TeV_pythia8_TuneCUETP8M1_GEN_SIM_Run3.root'])
