...
# with command line options: -s DIGI --mc --fileout file:GEN_SIM_postDIGI.root --conditions auto:phase1_2021_realistic --era Run3,fbcmDigi,OnlyfbcmDigi --geometry Extended2021Bcm1fMSMR --filein file:GEN_SIM_DIGI.root --pileup_input file:MinBias_14TeV_pythia8_TuneCUETP8M1_GEN_SIM.root --pileup "AVE_200_BX_25ns,{'B':(-3,3),'N':1.5}" --datatier GEN-SIM-DIGI-RAW --eventcontent FEVTDEBUG --python_filename postDIGI_cfg.py --customise SimFbcm/SiPadDigitizer/aging.no_aging,Configuration/DataProcessing/Utils.addMonitoring --nThreads 2 -n -1 --no_exe
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:GEN_SIM_DIGI.root'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN_SIM_postDIGI.root'),
