...
class BinnedInterval 
{
 public:
  ...
  BinnedInterval(double upperBinEdge,std::vector<double> intervalUpperBinEdges);
...
{
 public:
  BeamHaloParticleBuffer(std::string fileName,CLHEP::HepRandomEngine *engine);
 ...
 private:
  ...
  /** A map of the upper bin limits and a vector of bin limits within
